...
import { useReverseCustomerCreditEntry } from "@/lib/hooks/use-customer-credit";
...
export function ReverseCreditEntryModal({
  open,
  onOpenChange,
  entryId,
}: {
  ...
  const reverseEntry = useReverseCustomerCreditEntry();
